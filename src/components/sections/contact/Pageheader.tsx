      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-8 sm:py-12">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-muted-foreground">
                Access 12 powerful analytics modules designed for enterprise-scale data processing.
                From real-time monitoring to predictive insights, unlock your data's full potential.
              </p>
            </div>
          ...
          <div className="flex flex-wrap gap-4 mt-6 pt-6 border-t">
            ...
            <div className="text-sm text-muted-foreground">
              <span className="font-semibold text-foreground">2.3TB</span> Data processed daily
            </div>
            <div className="text-sm text-muted-foreground">
              <span className="font-semibold text-foreground">Real-time</span> Processing enabled
            </div>
          </div>
        </div>
      </div>
