...
export default function Contact() {
  ...
  const handlePrimaryAction = () => {
    router.push('/'); // Return to home after contact
  };
  const handleSecondaryAction = () => {
    router.push('/features'); // Show features for more info
  };
  ...
  const offices = [
    ...
    {
      city: 'Dublin',
      address: '94 Digital Park, Building C',
      timezone: 'GMT (UTC+0)',
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Connect with our SaaS experts to discover how our platform can streamline your workflows
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
          ...
          <Card className="border-border/50">
            <CardHeader>
              ...
              <CardDescription>
                Tell us about your requirements and we'll customize a demo for your team within 24
                hours.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Describe your current workflow challenges, team size, and integration requirements..."
                  />
                </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="mt-4 p-3 bg-primary/10 rounded-lg">
                  <p className="text-sm text-primary font-medium flex items-center gap-2">
                    ...
                    24/7 priority support for Enterprise tier customers
                  </p>
                </div>
